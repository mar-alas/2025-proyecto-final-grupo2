...
from aplicacion.lecturas.consultar_zonas import consultar_zonas_bp
...
URL_PROCESAR_VIDEO_RECOMENDACION = URL_PREFIX+"/productos/procesar-video-recomendacion"
URL_CONSULTAR_ZONAS = URL_PREFIX+"/zonas"
...
def create_app():
    ...
    app.register_blueprint(procesar_video_tienda_bp, url_prefix=URL_PROCESAR_VIDEO_RECOMENDACION)
    app.register_blueprint(consultar_zonas_bp, url_prefix=URL_CONSULTAR_ZONAS)
    return app
